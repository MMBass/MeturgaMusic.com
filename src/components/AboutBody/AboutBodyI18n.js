export default {
    ...
    SingleTransFooter: "כאשר משתמשים בתרגום אוטומטי המבוצע על ידי מכונה, התרגום אינו מושלם, לכן סיפקנו תרגום מילוני לכל מילה בנפרד, כך אם ההקשר של תרגום המשפט אינו מתאים, תוכלו להשוות עם תרגומים נוספים",
