export default {
  ...
  LyricsNotFound: 'אנו עובדים על המילים לשיר הזה, או שהשיר אינו בשפה האנגלית, חפשו שיר אחר או נסו שוב במועד מאוחר יותר',
  ...
  אתר זה משתמש בעוגיות ובאחסון מקומי בדפדפן, החיוניים לצורך תפקוד האתר. המשך השימוש באתר מהווה הסכמה למדיניות הפרטיות שלנו:
  `,
