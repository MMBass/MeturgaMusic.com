export default {
  ...
  אנו משתמשים באחסון מקומי בדפדפן ובמידע הנשלח באופן זמני אל השרת כגון עוגיות 
(LocalStorage, Cookies)
 וכלי ניתוח של גוגל, לצורך תפקוד בסיסי של האתר וכדי לשפר את חוויית הגלישה, ולצורך התאמת פרסומות. המשך השימוש באתר מהווה הסכמה למדיניות הפרטיות שלנו:
  `,
  PrivacyHref: "מדיניות הפרטיות",
