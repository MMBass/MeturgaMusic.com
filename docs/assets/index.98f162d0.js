...
`;function kr({className:t,...r}){const[n,u]=i.exports.useState(!1),[a,s]=i.exports.useState([]);i.exports.useEffect(()=>{},[]);const l=()=>{u(!0),a[0]||d()},o=()=>{u(!1)};function d(){const D="https://musicline-backend.vercel.app";let p=r.lyric.trim().toLowerCase();p=p.replaceAll(/[^a-zA-Z0-9']/g,""),p.slice(-1)==="'"&&(p=p.replaceAll("'","g")),fetch(`${D}/trans/single?initId=`+localStorage.getItem("init"),{method:"post",headers:{Accept:"application/json","Content-Type":"application/json"},body:JSON.stringify({single:encodeURI(p)})}).then(E=>E.json()).then(E=>{if(E!=null&&E.results[0]){s(E.results);return}else{s(["\u05DC\u05D0 \u05E0\u05DE\u05E6\u05D0\u05D5 \u05E2\u05D5\u05D3"]);return}}).catch(E=>{s(["\u05DC\u05D0 \u05E0\u05DE\u05E6\u05D0\u05D5 \u05E2\u05D5\u05D3"]),console.log(E)})}return e(B,{children:e(ft,{className:t,title:e(wr,{tooltipClose:o,className:"tt-childs",lyric:r.lyric,results:a}),arrow:!0,leaveTouchDelay:60*1e3,leaveDelay:3*1e3,PopperProps:{disablePortal:!1},onClose:o,open:n,disableFocusListener:!0,disableTouchListener:!0,disableHoverListener:!0,children:c("span",{children:["\xA0 ",c("p",{className:"single-lyric",onClick:l,children:[" ",r.lyric," "]})]})})})}const Ce=x(kr)`
